...
TARGET = omnikiwi
INSTALL_DIR = $(HOME)/apps/arduino-0023
PORT = /dev/ttyUSB0
UPLOAD_RATE = 57600
...
CINCS = -I$(ARDUINO) -I$(ARDUINO_LIBS) -I`pwd`
...
applet/$(TARGET).elf: applet/$(TARGET).o applet/core.a
	$(LD) $(ALL_LDFLAGS) -o $@ applet/$(TARGET).o -lm applet/core.a
